...
function Hero() {
  return (
    <section className='h-screen rounded-b-[15px] sm:flex-row flex-col justify-center overflow-hidden bg-[--black] flex items-center sm:justify-center text-[--white] px-[1em] sm:px-[--pdx] linear relative'>
        <div  className='text-center sm:w-[80%] flex flex-col gap-[2em] sm:gap-[15px] w-full'>
            ...
            <h1 className='sm:text-[6rem] text-[1.9rem] urba font-semibold capitalize line'>Everyone has a story. what's yours?</h1>
