...
function Hero() {
  return (
    <section className='h-screen overflow-hidden bg-[--black] flex items-center justify-center text-[--white] px-[--pdx] linear relative'>
        <div  className='text-center w-[80%] flex flex-col gap-[15px]'>
            ...
            <h1 className='text-[5rem] urba font-semibold capitalize line'>Every has a story. what's yours?</h1>
            <p className='urba text-[2rem] opacity-80'>Life's Tough Moments Deserve a Voice</p>
            <div className=''>
                <Button text={"Share a story"} inverse={false}/>
            </div>
        </div>
